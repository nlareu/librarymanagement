...
export function AssetForm({
  ...
  const handleAddTag = (
    ...
    if (currentArray.includes(valueWithPrefix)) {
      stateSetter("");
      return;
    }
    ...
    setFormData((prev) => ({
      ...prev,
      [formDataKey]: [...currentArray, valueWithPrefix],
    }));
    stateSetter("");
  };
  ...
  const handleRemoveTag = (indexToRemove: number, formDataKey: "subjects") => {
    ...
    setFormData((prev) => ({
      ...prev,
      [formDataKey]: currentArray.filter((_, index) => index !== indexToRemove),
    }));
  };
      ...
      <fieldset>
        ...
        <div className="form-grid">
          <div className="form-group" style={{ gridColumn: "1 / -1" }}>
            ...
            />
            {errors.title && (
              <p id="title-error" className="field-error-message">
                {errors.title}
              </p>
            )}
          </div>
          <div className="form-group">
            ...
            />
            {errors.author && (
              <p id="author-error" className="field-error-message">
                {errors.author}
              </p>
            )}
          </div>
        ...
        <div className="form-group">
          ...
          ></textarea>
          {errors.description && (
            <p id="description-error" className="field-error-message">
              {errors.description}
            </p>
          )}
        </div>
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className={errors.publisher ? "has-error" : ""}
            ...
            />
            {errors.publisher && (
              <p id="publisher-error" className="field-error-message">
                {errors.publisher}
              </p>
            )}
          </div>
          <div className="form-group">
            <label htmlFor="publicationPlace">
              {messages.publicationPlaceLabel}
            </label>
            <input
              id="publicationPlace"
              type="text"
              ...
              onChange={handleChange}
              className={errors.publicationPlace ? "has-error" : ""}
              aria-invalid={!!errors.publicationPlace}
              aria-describedby={
                errors.publicationPlace ? "publicationPlace-error" : undefined
              }
            />
            {errors.publicationPlace && (
              <p id="publicationPlace-error" className="field-error-message">
                {errors.publicationPlace}
              </p>
            )}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className={errors.edition ? "has-error" : ""}
              aria-invalid={!!errors.edition}
              aria-describedby={errors.edition ? "edition-error" : undefined}
            />
            {errors.edition && (
              <p id="edition-error" className="field-error-message">
                {errors.edition}
              </p>
            )}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className={errors.publicationYear ? "has-error" : ""}
              aria-invalid={!!errors.publicationYear}
              aria-describedby={
                errors.publicationYear ? "publicationYear-error" : undefined
              }
            />
            {errors.publicationYear && (
              <p id="publicationYear-error" className="field-error-message">
                {errors.publicationYear}
              </p>
            )}
          </div>
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              className={errors.collectionTitle ? "has-error" : ""}
              aria-invalid={!!errors.collectionTitle}
              aria-describedby={
                errors.collectionTitle ? "collectionTitle-error" : undefined
              }
            />
            {errors.collectionTitle && (
              <p id="collectionTitle-error" className="field-error-message">
                {errors.collectionTitle}
              </p>
            )}
          </div>
        ...
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={formData.isbn || ""}
              onChange={handleChange}
              className={errors.isbn ? "has-error" : ""}
              aria-invalid={!!errors.isbn}
              aria-describedby={errors.isbn ? "isbn-error" : undefined}
            />
            {errors.isbn && (
              <p id="isbn-error" className="field-error-message">
                {errors.isbn}
              </p>
            )}
          </div>
        ...
        <div className="tag-input-section">
            ...
            <div className="tags-list">
              {formData.subjects.map((subject, index) => (
                <div key={index} className="tag-item">
                  ...
                  <button
                    type="button"
                    onClick={() => handleRemoveTag(index, "subjects")}
                  >
                    &times;
                  </button>
                </div>
          ...
          <div className="tag-add-form">
            <input
              ...
              onKeyDown={(e) =>
                handleTagInputKeyDown(e, newSubject, setNewSubject, "subjects")
              }
              placeholder={messages.addSubjectPlaceholder}
            />
            <button
              type="button"
